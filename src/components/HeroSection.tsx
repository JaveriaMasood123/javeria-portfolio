    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
             Full Stack Developer & BS Computer Science Student
          </motion.p>
          ...
          >
            Building elegant web solutions using React, Node.js, and modern web technologies.
          </motion.p>
          ...
          >
            <motion.div className="flex flex-row items-center gap-4">
              {/* Contact Button */}
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="touch-target">
          ...
          <div className="relative">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-xs text-gray-500">javeria.js</div>
              </div>
              ...
              <div className="space-y-2 font-mono text-sm">
                ...
                <motion.div className="pl-6" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.4, duration: 0.3 }}>
                  <span className="text-purple-600">name</span>
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Javeria Masood'</span>
                  <span className="text-gray-500">,</span>
                </motion.div>

                <motion.div className="pl-6" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.6, duration: 0.3 }}>
                ...
                <motion.div className="pl-6" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.8, duration: 0.3 }}>
                ...
                <motion.div className="pl-6" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 2.0, duration: 0.3 }}>
